...
<body>
<?php
$result = mysqli_query($conn,"SELECT * FROM planejamento_fornecedores where ID='$id' order by data_planejamento");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="valida_pagar_fornecedor.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="id" value="<?php echo $id; ?>">
          <input type="hidden" name="fornecedor" value="<?php echo $fornecedor; ?>">
          <input type="hidden" name="categoria" value="<?php echo $categoria; ?>">
          <input type="hidden" name="fornecimento" value="<?php echo $fornecimento; ?>">
          ...
          <input type="hidden" name="observacao" value="<?php echo $observacao; ?>">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="file" name="arquivo_fornecedor" class="form-control" id="arquivo_fornecedor">
              </div>
            </div>
