...
<body>
<?php
$result = mysqli_query($conn,"SELECT * FROM planejamento_representantes where ID='$id' order by data_planejamento");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="valida_pagar_representante.php" method="POST" enctype="multipart/form-data">
          ...
          <input type="hidden" name="observacao" value="<?php echo $observacao; ?>">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="file" name="arquivo_representante" class="form-control" id="arquivo_representante">
              </div>
            </div>
            <div class="modal-footer">
                <a href="representantes.php"><button class="btn btn-secondary">Cancelar</button></a>
