...
$result_planejamento = "INSERT INTO historico_despesas(antigo_id, categoria, equipe, local, valor_planejamento, data_planejamento, valor_pago, data_paga, observacao, created)
VALUES('$id','$categoria','$equipe','$local','$valor_planejamento','$data_planejamento','$valor_pago','$data_paga','$observacao',NOW())";
