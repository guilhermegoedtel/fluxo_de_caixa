...
<table class="table table-bordered">
  ...
  <tbody>
    <?php
    $result = mysqli_query($conn,"SELECT * FROM historico_despesas");
    ...
    <td><a href="comprovante_despesa.php?ID=<?php echo($row['antigo_id']); ?>"><img src="../images/anexo.png" width="64" height="64"></a></td>
    </tr>
    <?php
    }
    ?> 
