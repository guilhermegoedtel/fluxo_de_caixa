...
<div id="page-content-wrapper">
    <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add_despesas">Cadastra Despesa</button>
...
<table class="table table-bordered">
  ...
  <tbody>
    <?php
    $result = mysqli_query($conn,"SELECT * FROM planejamento_despesas ORDER BY data_planejamento");
    ...
    <td>
    <a href="pagar_taxa_despesa.php?ID=<?php echo($row['ID']); ?>"><button class="btn btn-success">Pagar</button></a>
    </td>
    </tr>
    <?php
    }
...
<!-- Fim Modificar -->
<div class="modal fade" id="add_despesas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="add_despesasLabel">Adicionar Planejamento de Despesas</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="valida_despesas.php" method="POST">
