...
<div id="page-content-wrapper">
    <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add_cliente">Adicionar Cliente</button>
...
$result_diario = "SELECT * FROM cliente";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="add_clienteLabel">Cadastrar Cliente</h5>
      ...
      <div class="modal-body">
        <form action="valida_cliente.php" method="POST">
            ...
            <div class="modal-footer">
                ...
                <input type="submit" name="add_cliente" id="add_cliente" value="Salvar" class="btn btn-primary">
            </div>
        </form>
    </div>
  </div>
