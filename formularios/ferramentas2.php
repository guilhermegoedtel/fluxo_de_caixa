...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <td>
<!--Alteração Teste -->
    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#altera_status">Alterar</button>
    <div class="modal fade" id="altera_status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="altera_statusLabel">Alterar Status</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    <div class="modal-body">
        <form action="altera_status.php?ID=<?php echo($row['ID']); ?>" method="POST">
            ...
            <div class="modal-footer">
                ...
                <input type="submit" name="altera_status" id="altera_status" value="Alterar" class="btn btn-primary">
            </div>
        </form>
    </div>
  </div>
...
<!--Guarda Aqui-->
    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleta_status">Excluir</button>
    </td>
    </tr>
    <?php
    }
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="altera_status.php" method="POST">
          <input type="text" name="ID" value="<?php //echo $guarda; ?>" disabled>
            <div class="form-group">
                <label>Status:</label>
                <select name="status" class="form-control" id="status">
                <option value="" selected>Status da ferramenta</option>
...
<div class="modal fade" id="deleta_status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="deleta_status.php" method="POST">
            <div class="form-group">
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Tem certeza da exclusão ?:</label>
                <select name="periodo" class="form-control" id="periodo">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <input type="submit" name="deleta_status" id="deleta_status" value="Deletar" class="btn btn-primary">
            </div>
        </form>
    </div>
  </div>
