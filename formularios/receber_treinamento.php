...
<body>
<?php
$result = mysqli_query($conn,"SELECT * FROM entrada_treinamento where ID='$id'");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="valida_receber_treinamento.php" method="POST">
          <input type="hidden" name="id" value="<?php echo $id; ?>">
          <input type="hidden" name="treinamento" value="<?php echo $treinamento; ?>">
          ...
          <input type="hidden" name="observacao" value="<?php echo $observacao; ?>">
            ...
            <div class="modal-footer">
                <a href="entrada_treinamento.php"><button class="btn btn-secondary">Cancelar</button></a>
