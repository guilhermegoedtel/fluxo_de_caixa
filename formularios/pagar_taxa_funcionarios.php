...
<body>
<?php
$result = mysqli_query($conn,"SELECT * FROM planejamento_funcionarios where ID='$id' order by data_planejamento");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="valida_pagar_funcionario.php" method="POST" enctype="multipart/form-data">
          ...
          <input type="hidden" name="observacao" value="<?php echo $observacao; ?>">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="file" name="arquivo_funcionario" class="form-control" id="arquivo_funcionario">
              </div>
            </div>
