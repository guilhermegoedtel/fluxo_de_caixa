...
<div id="page-content-wrapper">
    <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add_representante">Adicionar Representante</button>
...
$result_diario = "SELECT * FROM representante";
...
<div class="modal fade" id="add_representante" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="add_representanteLabel">Cadastrar Fornecedors</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="valida_add_representante.php" method="POST">
            <div class="form-group">
                <label>Nome do Representante</label>
                <select name="responsavel" class="form-control" id="responsavel">
                    <option value="" selected>Selecione um Fornecedor</option>
                    <?php
                    $result = mysqli_query($conn,"SELECT nome FROM usuario where nv_acesso='1'");
            ...
            <div class="modal-footer">
                ...
                <input type="submit" name="add_representante" id="add_representante" value="Salvar" class="btn btn-primary">
            </div>
        </form>
    </div>
  </div>
