...
<div class="modal fade" id="deleta_status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleta_statusLabel">Adicionar visita</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="deleta_status.php" method="POST">
            ...
            <div class="form-group">
                <label>Certeza da exclusão ?:</label>
                <select name="certeza" class="form-control" id="certeza">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <input type="submit" name="deleta_status" id="deleta_status" value="Salvar" class="btn btn-primary">
            </div>
        </form>
    </div>
  </div>
