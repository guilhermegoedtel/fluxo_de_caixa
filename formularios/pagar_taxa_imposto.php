...
<body>
<?php
$result = mysqli_query($conn,"SELECT * FROM planejamento_impostos where ID='$id' order by data_planejamento");
while($row = mysqli_fetch_array($result)){
    $impostos_encargos = $row['impostos_encargos'];
    $descricao_impostos_encargos = $row['descricao_impostos_encargos'];
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="valida_pagar_imposto.php" method="POST">
          <input type="hidden" name="id" value="<?php echo $id; ?>">
          <input type="hidden" name="impostos_encargos" value="<?php echo $impostos_encargos; ?>">
          <input type="hidden" name="descricao_impostos_encargos" value="<?php echo $descricao_impostos_encargos; ?>">
